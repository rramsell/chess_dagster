            ...
            coalesce(
                ...
                case
                    ...
                    then time_control_seconds
                        ...
                        - {{ time_control_increment_seconds_sum }}
                    else
	...
	case 
        ...
        then coalesce(
            ...
            case
                ...
                else lag(black_clock) over (partition by game_id order by round)
                end
            )
        else black_clock
    end as black_clock,
    ...
    case
        ...
        then coalesce(
            ...
            case
                ...
                -- their time left on the clock does not
                -- change from the previous round
                else lag(black_remaining_seconds) over (partition by game_id order by round)
            end
        )
